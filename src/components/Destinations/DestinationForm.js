...
import { addDestination, updateDestination } from '../../store/actions/destinationActions'

const DestinationForm = ({ destination, editDestination, createDestination }) => {
  ...
  return (
    <div>
      ...
      <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        <DialogTitle id="form-dialog-title">{edit ? "Editar" : "Agregar"} Destino</DialogTitle>
        <DialogContent>
